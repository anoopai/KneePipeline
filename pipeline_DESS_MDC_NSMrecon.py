...
output_file = os.path.join(log_path, f'pipleine_DESS_MDC_NSMrecon.txt')
mean_data_path = os.path.join(code_dir_path, 'mean_data')
save_path = os.path.join(mean_data_path, 'spatial_autocorrelation/NSMrecon')
mean_femur_path = os.path.join(mean_data_path, 'MeanFemur_mesh_B-only.vtk')
mdc_femur_path =os.path.join(save_path, f'MDC_Mean_NSMrecon_femur_mesh_{knee}_{visit}.vtk')
