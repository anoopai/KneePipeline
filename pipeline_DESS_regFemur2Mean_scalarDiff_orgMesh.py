...
output_file = os.path.join(log_path, f'pipeline_DESS_regFemur2Mean_scalarDiff_orgMesh_{knee_to_use}.txt')
log_file_path = os.path.join(log_path, f'pipeline_DESS_regFemur2Mean_scalarDiff_orgMesh.txt')
                ...
                if os.path.isdir(visit_path):
                    ...
                    for knee in os.listdir(visit_path):
                        ...
                        if os.path.isdir(knee_path) and knee == knee_to_use:
                            ...
                            femur_path = os.path.join(path_save, 'femur_mesh_NSM_orig.vtk')
                            ...
                            if os.path.exists(path_image):
                                ...
                                ########################################################################################     
                                mean_path_reg = os.path.join(path_save, 'femur_mesh_NSM_orig_reg2mean.vtk')
                ...
                if os.path.isdir(visit_path):
                    ...
                    for knee in os.listdir(visit_path):
                        ...
                        if os.path.isdir(knee_path) and knee == knee_to_use:
                            ...
                            femur_path_v1 = os.path.join(path_save_v1, 'femur_mesh_NSM_orig_reg2mean.vtk')
                            ...
                            try:
                                ...
                                diff_scalar_names = ['thickness (mm)', 'T2_mean', 'labels']
