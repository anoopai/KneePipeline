...
output_file = os.path.join(log_path, f'NSM_{knee_to_use}.txt')
...
def call_pipeline_script(script, path_image, path_save, log_file_path):
    command = [
        'python',
        script,  
        path_image,
                    ...
                    if os.path.isdir(visit_path):
                        ...
                        for knee in os.listdir(visit_path):
                            ...
                            if os.path.isdir(knee_path) and knee == knee_to_use:
                                ...
                                recon_path = os.path.join(path_save, 'NSM_bone_only_recon_params.json')
                                ...
                                if os.path.exists(recon_path):
                                    os.remove(recon_path)  # Remove existing recon file if it exists
